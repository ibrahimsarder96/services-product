...
const Apple = () => {
  return (
    ...
    <h1 className='text-center text-accent text-3xl'><span  className='font-extrabold'>Apple Macbook </span> Repair Service</h1>
    <section>
