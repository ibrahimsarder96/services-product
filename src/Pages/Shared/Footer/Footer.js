...
const Footer = () => {
  ...
  return (
    ...
    <span className="text-xl font-bold text-white">Customer Care</span> 
      ...
      <Link to='/' className='text-white'>Seller Registration</Link>
  ...
  <div>
    <span className="text-xl font-bold text-white">Company</span> 
      <Link to='/laptop' className='text-white'>Laptop</Link>
      <Link to='/computer' className='text-white'>Computer</Link>
      <Link to='/monitor' className='text-white'>Monitor</Link>
      <Link to='/appel' className='text-white'>Appel Macbook</Link>
      <Link to='/printer' className='text-white'>Printer</Link>
      <Link to='/motherboard' className='text-white'>Mother board</Link>
      <Link to='/' className='text-white'>Call Us (9:00am-07:00pm)</Link>
  </div> 
  <div>
...
<footer className="footer py-4 border-t bg-black text-base-content border-base-300 px-24">
  ...
  <div className="md:place-self-center md:justify-self-end">
    <h1 className='text-xl text-white font-bold'>Flow Us</h1>
    <div className="grid grid-flow-col gap-4">
      ...
      <Link to='/'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-white"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link>
    </div>
  </div>
</footer>
